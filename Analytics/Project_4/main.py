...
# 1.4 Convert columns to numeric (if required)
for col in cols:
...
print("Filtering houses through price > 1000000", expensive_houses)
print("========================================================")

# 3.2 Count number of houses per bedrooms
bedroom_counts = expensive_houses['bedrooms'].value_counts()
print("Counting Number of houses per bedrooms", bedroom_counts)
print("========================================================")

# 3.3 Select top bedroom categories (e.g., top 5)
...
print("\ncounting number of houses bedrooms", bedroom_counts)
print("========================================================")

# 4.2 Select top 5 bedroom categories
top5 = bedroom_counts.head()
print("\nSelecting Top 5 bedroom categories", top5)
print("========================================================")
