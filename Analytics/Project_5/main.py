...
# 7. Save graph
plt.savefig("Graphs/expensive_cars_fueltype_bar.png")
...
# Save graph
plt.savefig("Graphs/present_vs_selling_price.png")
...
plt.savefig("Graphs/Car_count.png") # To save the graph
plt.show()  
...
# 5. Save graph
plt.savefig("Graphs/Histogram_Kms_Driven.png")
...
# Save graph
plt.savefig("Graphs/Transmission_vs_SellingPrice.png")
...
# Save graph
plt.savefig("Graphs/seller_type_analysis.png")
...
plt.xlabel("Fuel Type")
plt.ylabel("Average Selling Price")
plt.savefig("Graphs/fuel_type_avg_price.png")
plt.show()
